        ...
        <li>
          ...
          <div className={`dropdown ${openSection === 2 ? "active" : ""}`}>
            {["Cartier", "Omega", "Bulova", "Mercier", "Rolex"].map((brand) => (
              <p
                key={brand}
                onClick={(event) => handleFilterClick(event, "brand", brand)}
                className={
        ...
        <li>
          ...
          <div className={`dropdown ${openSection === 3 ? "active" : ""}`}>
            {[
              ...
              <p
                key={model}
                onClick={(event) => handleFilterClick(event, "model", model)}
                className={
          ...
          <div className={`dropdown ${openSection === 5 ? "active" : ""}`}>
            {[
              ...
              <p
                key={date}
                onClick={(event) =>
                  handleFilterClick(event, "releaseDate", date)
                }
                className={
          ...
          <div className={`dropdown ${openSection === 6 ? "active" : ""}`}>
            {[
              ...
              <p
                key={diameter}
                onClick={(event) =>
                  handleFilterClick(event, "diameter", diameter)
                }
                className={
              ...
              >
                <span
                  className={`bubble ${
                    selectedFilters.diameter.includes(diameter)
                      ? "selected"
                      : ""
                  }`}
                ></span>
        ...
        <li>
          ...
          <div className={`dropdown ${openSection === 7 ? "active" : ""}`}>
            {["Round", "Square"].map((shape) => (
              <p
                key={shape}
                onClick={(event) => handleFilterClick(event, "shape", shape)}
                className={
